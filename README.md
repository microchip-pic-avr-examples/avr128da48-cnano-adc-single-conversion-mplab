...
# AVR128DA48 ADC Single Conversion

## Objective

In this application, the ADC will perform single conversions, and the results will be transmitted through USART.
...
2. Open the *avr128da48-cnano-adc-single-conversion-mplab.X* project in MPLAB® X IDE.

3. Set *avr128da48-cnano-adc-single-conversion-mplab.X* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*:
